...
class Network():
    def CreateTarget(self, inputs):
        with tf.variable_scope('target'):
            ...
            split_5 = tflearn.conv_1d(inputs[:, 5:6, :self.a_dim], FEATURE_NUM, 1, activation='relu')
            split_6 = tflearn.fully_connected(inputs[:, 6:7, -1], FEATURE_NUM, activation='relu')
            split_7 = tflearn.fully_connected(inputs[:, 7:8, :2], FEATURE_NUM, activation='relu')
            ...
            merge_net = tflearn.merge([split_0, split_1, split_2_flat, split_3_flat, split_4_flat, \
                split_5_flat, split_6, split_7], 'concat')
